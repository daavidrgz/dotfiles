...
# Launch Rofi
MENU="$(rofi -no-config -no-lazy-grab -show-icons -sep "|" -dmenu -i -p '' \
-theme $SDIR/rofi/styles.rasi \
<<< " amber| blue| panda| blue-gray| brown| cyan| deep-orange|\
 deep-purple| green| gray| indigo| blue-light| green-light|\
 lime| orange| pink| purple| red| teal| yellow| amber-dark|\
 blue-dark| panda-dark| blue-gray-dark| brown-dark| cyan-dark| deep-orange-dark|\
...
case "$MENU" in
	...
	*panda) "$SDIR"/colors-light.sh --panda ;;
	...
	*panda-dark) "$SDIR"/colors-dark.sh --panda ;;
